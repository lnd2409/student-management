...
class CreateMonHocSinhVienTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mon_hoc_sinh_vien', function (Blueprint $table) {
            $table->id();
            $table->integer('mhsv_diem_1');
            $table->integer('mhsv_diem_2');
            $table->integer('mhsv_diem_phuc_khao_1');
            $table->integer('mhsv_diem_phuc_khao_2');
            $table->integer('mhsv_diemtong');
            $table->string('mhsv_diemchu',1);
