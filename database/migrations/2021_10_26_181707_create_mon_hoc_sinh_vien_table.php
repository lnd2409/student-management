...
class CreateMonHocSinhVienTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mon_hoc_sinh_vien', function (Blueprint $table) {
            $table->id();
            $table->integer('mhsv_diem_1')->nullable();
            $table->integer('mhsv_diem_2')->nullable();
            $table->integer('mhsv_diem_phuc_khao_1')->nullable();
            $table->integer('mhsv_diem_phuc_khao_2')->nullable();
            $table->integer('mhsv_diemtong')->nullable();
            $table->string('mhsv_diemchu',2)->nullable();
